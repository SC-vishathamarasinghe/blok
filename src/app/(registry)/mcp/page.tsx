        ...
        <main className="w-full bg-subtle-bg">
            ...
            <div className="px-32">
                <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
                    ...
                    <Codeblocks showLineNumbers={true} code={BlockRegistryCode} variant="filled" />
                </div>
                ...
                <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
                    ...
                    <Tabs defaultValue="claude">
                        ...
                        <TabsContent value="claude" className="space-y-2">
                            ...
                            <Codeblocks showLineNumbers={false} code={`npx shadcn@latest mcp init --client claude`} variant="filled" />    
                        ...
                        <TabsContent value="cursor" className="space-y-2">
                            ...
                            <Codeblocks showLineNumbers={false} code={`npx shadcn@latest mcp init --client cursor`} variant="filled" />
                        ...
                        <TabsContent value="vscode" className="space-y-2">
                            ...
                            <Codeblocks showLineNumbers={false} code={`npx shadcn@latest mcp init --client vscode`} variant="filled" />
                        ...
                        <TabsContent value="codex" className="space-y-2">
                            ...
                            <Codeblocks showLineNumbers={false} code={`npx shadcn@latest mcp init --client codex`} variant="filled" />
...
command = "npx"
args = ["shadcn@latest", "mcp"]`} variant="filled" />
                ...
                <div className="flex flex-col space-y-3 p-5 md:pt-10 md:px-10">
                    ...
                    <Codeblocks code={CursorConfigurationCode} showLineNumbers={true} variant="filled" />
